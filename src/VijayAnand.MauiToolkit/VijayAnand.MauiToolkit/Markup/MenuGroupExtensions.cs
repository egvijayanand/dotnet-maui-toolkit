...
public static class MenuGroupExtensions
{
    ...
    public static TMenuBarItem AddMenuGroup<TMenuBarItem>(
        this TMenuBarItem topMenu,
        IMenuFlyoutSubItem menuGroup)
    ...
    public static TMenuFlyoutSubItem AddSubMenuGroup<TMenuFlyoutSubItem>(
        this TMenuFlyoutSubItem parentMenu,
        IMenuFlyoutSubItem subMenuGroup)
        where TMenuFlyoutSubItem : IMenuFlyoutSubItem
    {
    ...
    public static TMenuFlyoutSubItem AddMenuItem<TMenuFlyoutSubItem>(
        this TMenuFlyoutSubItem topMenu,
        IMenuFlyoutItem menuItem)
        where TMenuFlyoutSubItem : IMenuBarItem
    {
    ...
    public static TMenuFlyoutSubItem AddSubMenuItem<TMenuFlyoutSubItem>(
        this TMenuFlyoutSubItem menuGroup,
        IMenuFlyoutItem menuItem)
        where TMenuFlyoutSubItem : IMenuFlyoutSubItem
    {
    ...
    public static TMenuFlyoutSubItem AddMenuSeparator<TMenuFlyoutSubItem>(this TMenuFlyoutSubItem menuGroup)
        where TMenuFlyoutSubItem : IMenuFlyoutSubItem
    {
        menuGroup.Add(new MenuFlyoutSeparator());
        return menuGroup;
    }
#endif
}
